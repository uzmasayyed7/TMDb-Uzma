...
class MovieListViewController: UIViewController {
    ...
    private let cellReuseIdentifier = "LatestMovTableViewCell"
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(LatestMovTableViewCell.self, forCellReuseIdentifier: cellReuseIdentifier)
...
extension MovieListViewController: UITableViewDelegate, UITableViewDataSource, MovieListViewControllerProtocol {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellReuseIdentifier) as? LatestMovTableViewCell else {
